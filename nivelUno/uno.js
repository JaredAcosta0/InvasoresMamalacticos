...
function movimientoInvader() {
  ...
  if (alienEliminado.length === aliniacionIn.length) {
    cambio.innerHTML = '<div style="padding-top: 35vh;"><h1 class="otro">YOU WIN Level 1</h1><div class="center"><a href="../nivel.html" class="btn-neon"><span id="span1"></span><span id="span2"></span><span id="span3"></span><span id="span4"></span>Levels</a><a href="../nivelDos/index.html" class="btn-neon"><span id="span1"></span><span id="span2"></span><span id="span3"></span><span id="span4"></span>Next Level -></a></div></div>'
    clearInterval(invadersId)
  }
}
invadersId = setInterval(movimientoInvader, 500)
